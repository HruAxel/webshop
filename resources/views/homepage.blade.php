...
<div class="col-12">
    ...
    <div class="my-3 mx-5 px-5 d-flex justify-content-center flex-wrap" >



        @foreach ($list as $item)
            <form action="/add-to-cart/{{$item->id}}" method="post" class="product-card d-flex flex-column mx-1 my-3 align-items-center ">
                @csrf
                @if ($item->thumbnail)
